...
// TODO: Maybe move these away from config
// Database table names
const (
	UserTable        = "rs_user"
	SportTable       = "rs_sport"
	GameTable        = "rs_game"
	GamePlayersTable = "rs_game_players"
	SessionTable     = "rs_session"
	ConfigTable      = "rs_config"
	AuditTable       = "rs_audit_trail"
)

// Events for audit trail
const (
	EventUnknownTag = "unknown_tag"
)

// Game result statuses
const (
	StatusLoss = 0
	StatusWon  = 1
	StatusTie  = 2
